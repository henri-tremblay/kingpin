...
get the app created:
    ...
    $ heroku apps:create kingpin
    Creating kingpin... done, stack is cedar
    http://kingpin.herokuapp.com/ | git@heroku.com:kingpin.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://kingpin.herokuapp.com deployed to Heroku

    To git@heroku.com:kingpin.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://kingpin.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@kingpin.herokuapp.com/repl
